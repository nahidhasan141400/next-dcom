      ...
      <div className="max-w-md mx-auto my-10">
          ...
          <div className="m-7">
              <form action="">
                  ...
                  <div className="mb-6">
                      <button type="button" className="w-full px-3 py-4 text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:bg-indigo-600 focus:outline-none">Sign in</button>
                  </div>
