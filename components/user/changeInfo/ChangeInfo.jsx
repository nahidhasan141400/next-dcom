...
const ChangeInfo = () => {
  return (
    <div>
        <section className="max-w-4xl p-6 mx-auto bg-white rounded-md md:shadow-md dark:bg-gray-800">
    <h2 className="text-lg font-semibold text-gray-700 capitalize dark:text-white">Update user information</h2>
    ...
    <form>
        <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div>
                <label className="text-gray-700 dark:text-gray-200" for="password">phone</label>
